...
/**
 * Interface that defines the request lifecycle used by {@link AbsHttpClient}.
...
public interface RequestHandler {
     ...
     * @throws IOException
     */
    void prepareConnection(HttpURLConnection urlConnection, HttpMethod httpMethod) throws IOException;
     ...
     * by {@link AbsHttpClient}. Any exceptions caught should
    ...
    void writeHeaders(HttpURLConnection urlConnection, HttpMethod httpMethod);
    /**
     ...
     * @throws IOException
     */
    void writeStream(HttpURLConnection urlConnection, HttpMethod httpMethod) throws IOException;
     ...
     * @throws IOException
     */
    HttpResponse readInputStream(HttpURLConnection urlConnection) throws IOException;
